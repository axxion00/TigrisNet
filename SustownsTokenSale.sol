...
import "./SustownsToken.sol";

contract SustownsTokenSale {
    address payable admin;
    SustownsToken public tokenContract;
    uint256 public tokenPrice;
    uint256 public tokensSold;

    event Sell(address _buyer, uint256 _amount);

    constructor(SustownsToken _tokenContract, uint256 _tokenPrice) public {
        admin = msg.sender;
